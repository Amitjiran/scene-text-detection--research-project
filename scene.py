...
def text_detector(image):
 ...
 (numRows, numCols) = scores.shape[2:4] rects = []
 confidences = []
...
for i in range(0,2):
 for img in array:
  imageO = cv2.resize(img, (640,640), interpolation = cv2.INTER_AREA)
  orig = cv2.resize(img, (640,640), interpolation = cv2.INTER_AREA)
